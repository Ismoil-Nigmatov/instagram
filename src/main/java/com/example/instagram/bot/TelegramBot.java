...
import com.example.instagram.dto.youtube.FormatsItem;
import com.example.instagram.dto.youtube.YouTube;
                ...
                try {
                    ...
                    if (body.contains("[")) {
                        ...
                        if (instagram.getType().equals("Post-Image")) {
                            ...
                            execute(SendMessage.builder().chatId(String.valueOf(update.getMessage().getChatId())).text("For now we can't download it ").build());
                    }
                } catch (Exception e) {
